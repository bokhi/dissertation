...
qsub -N Isomap -v FILE=view1.mat,TECHNIQUE=Isomap,DIMENSION=$DIM,PARAMETER=53 dimension_reduction.sh
qsub -N LLE -v FILE=view1.mat,TECHNIQUE=LLE,DIMENSION=$DIM,PARAMETER=137 dimension_reduction.sh
...
qsub -N ACC_SIFT -hold_jid LLE -t 1:$DIM:50 -v FILE='view1.mat',NB_DIM=50 accuracy.sh
