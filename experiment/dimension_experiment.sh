...
qsub -N Isomap -v FILE=view1,TECHNIQUE=Isomap,DIMENSION=$DIM,PARAMETER=13 dimension_reduction.sh
qsub -N LLE -v FILE=view1,TECHNIQUE=LLE,DIMENSION=$DIM,PARAMETER=17 dimension_reduction.sh
...
qsub -N sqrt_Isomap -v FILE=sqrt_view1,TECHNIQUE=Isomap,DIMENSION=$DIM,PARAMETER=9 dimension_reduction.sh
qsub -N sqrt_LLE -v FILE=sqrt_view1,TECHNIQUE=LLE,DIMENSION=$DIM,PARAMETER=8 dimension_reduction.sh
