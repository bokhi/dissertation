function [] = select_best_parameter (file, fold, cross, method, k)
  ...
  for j = pca_dims(1):pca_dims(2)
    ...
    acc(j, method_dims(1):method_dims(1)+method_dims(2)-1) = accuracy (method_train_Data, method_test_Data, train_SS, train_DD, test_SS, test_DD, method_dims(1), method_dims(2));
  end
