...
qsub -N pca_Isomap_k -hold_jid PCA -t $1-$2 -v FILE=PCA_view1,METHOD=Isomap,K=0 pca_experiment.sh
qsub -N pca_LLE_k -hold_jid PCA -t $1-$2 -v FILE=PCA_view1,METHOD=LLE,K=0 pca_experiment.sh
...
qsub -N sqrt_pca_Isomap_k -hold_jid sqrt_PCA -t $1-$2 -v FILE=PCA_sqrt_view1,METHOD=Isomap,K=0 pca_experiment.sh
qsub -N sqrt_pca_LLE_k -hold_jid sqrt_PCA -t $1-$2 -v FILE=PCA_sqrt_view1,METHOD=LLE,K=0 pca_experiment.sh
