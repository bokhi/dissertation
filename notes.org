...
* <2012-08-07 Tue>
** Tasks
*** TODO analyse the results of the experiment
*** TODO trace diagrams
*** TODO fix failed experiments
...
*** Eigenproblem and dimension reduction for nonlinear methods
    - can the dimension be further reduced by simply removing additional features?
*** convert extract_view2
*** similar "unique" modification for testing dataset
