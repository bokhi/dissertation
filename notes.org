...
** view2 pca-prereduction cross validation
...
** view1 pca-prereduction
   ...
   | method           |     LDA |  Isomap |     LLE |
   |------------------+---------+---------+---------|
   | acc              | 0.81000 | 0.65800 | 0.68100 |
   | pca              |      78 |      50 |      58 |
   | second reduction |      25 |      42 |      35 |
   |------------------+---------+---------+---------|
   | sqrt-acc         | 0.81000 | 0.65500 | 0.65400 |
   | pca              |      62 |      55 |      51 |
   | second reduction |      29 |      44 |      29 |
...
** view2
   ...
   sqrt_LDA : re-run error with fold parameter:

   {^HAttempted to access pca_dim(10); index out of bounds because numel(pca_dim)=9.

   Error in view2_experiment (line 37)
   [pca_train_Data, pca_test_Data] = dimension_reduction(train_Data, test_Data,
   train_SS, train_DD, 'PCA', pca_dim(fold), []);
   }^H
   ^G
